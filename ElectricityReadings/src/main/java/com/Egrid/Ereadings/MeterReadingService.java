...
public class MeterReadingService {
	...
	public String CreateMeterReading(@FormParam("MID") String MID,@FormParam("ID") String ID, @FormParam("Last_Reading") double Last_Reading,
			@FormParam("New_Reading") double New_Reading, @FormParam("Reviewed_By") String Reviewed_By,
			@FormParam("Reviewed_Date") Date Reviewed_Date) {
